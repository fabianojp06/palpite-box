...
const Pesquisa = () => {
    ...
    return ( 
         <div className='pt-6'>
            ...
            <input type='text' className='p-4 block shadow bg-blue-100 my-2 rounded' 
            placeholder='Sugestao'onChange={onChange} name='Sugestao' value={form.Sugestao}/> 
            ...
            <button className='bg-blue-400 px-16 py-4 font-bold rounded-lg shadow-lg hover:shadow p-6'
          ...
          {sucess && <div className='w-1/5 mx-auto'>
            <p className='mb-6 text-center bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3'>
              ...
              {
                  retono.showCoupon && <div className='text-center border p-4 mb-4'>
                      Seu cupom: <br />
                      <span className='font-bold text-2xl'>{retono.Cupom}</span>
                    </div>
              }
              {
                  retono.showCoupon && <div className='text-center p-4 mb-4'>
                    <span className='font-bold block mb-2'>{retono.Promo}</span>
                    <br />
                    <span className='italic text-1xl'>Tire um print ou foto desta tela e apresente ao garçon.</span>
                    </div>
              }
